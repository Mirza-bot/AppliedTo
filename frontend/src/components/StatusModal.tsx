      ...
      <div className="relative bg-white w-80 p-6 rounded-lg shadow-lg">
        ...
        <div className="outline-2 outline outline-grey rounded mb-5">
          <div className="flex flex-col gap-0.5 bg-grey text-center">
            <button className="p-2 bg-white" onClick={() => submit("Applied")}>
              Applied
            </button>
            <button
            ...
            <button className="p-2 bg-white" onClick={() => submit("Ghosted")}>
              Ghosted
            </button>
            <button className="p-2 bg-white" onClick={() => submit("Rejected")}>
              Rejected
            </button>
            <button className="p-2 bg-white" onClick={() => submit("Accepted")}>
              Accepted
            </button>
          </div>
        </div>
